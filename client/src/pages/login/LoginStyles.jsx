...
export const FormContainer = styled.div`
  ${tw`flex flex-col items-center justify-center w-full max-w-md border rounded-lg shadow-2xl dark:border-gray-800 h-96 shadow-gray-100 dark:shadow-gray-900 bg-gradient-to-t dark:from-gray-800/60 dark:to-slate-800/60 from-gray-200/60 to-slate-200/60 backdrop-filter backdrop-blur-lg`}
...
export const LoadingWrapper = styled.div`
  ...
  svg {
    ${tw`animate-spin  -ml-4 mr-3 h-5 w-5`}
  }
  circle {
    ${tw`opacity-25`}
  }
