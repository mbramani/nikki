...
`
export const MonthCardDisabled = styled(MonthCard)`
  ${tw`text-gray-500/80 dark:text-gray-400/80 dark:from-gray-800/20 dark:to-slate-800/20 from-gray-200/20 to-slate-200/20 hover:ring-0`}
`
